...
namespace Echiquier
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cavalier.AfficherPosition();
            while (cavalier.Emplacement != "H8")
            {
                cavalier.DeplacerAlea();
                cavalier.AfficherPosition();
            }
            Console.Read();
        }
    ...
    class Echiquier
    {
        ...
        internal bool Deplace(Piece piece, Point decalage)
        {
            ...
            int posY = int.Parse(piece.Emplacement[1].ToString()) + decalage.y;
    ...
    class Cavalier : Piece
    {
        ...
        {
            // 1. Générer un nombre entre 0 et 7
            int n = 0;
            do
            {
                n = Alea.Next(0, 8);
    ...
    class Piece
    {
        ...
        internal void AfficherPosition()
        {
            Console.WriteLine("{0} : {1}", Compteur, Emplacement);
            Compteur++;
        }
